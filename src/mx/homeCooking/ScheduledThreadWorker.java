...
public class ScheduledThreadWorker extends AbstractExecutorService {
     ...
     *
     */
    public ScheduledThreadWorker(String name, Runnable check) {
    ...
    public final void schedule(Runnable command, long delay,TimeUnit unit){
        schedule(command,unit.toMillis(delay));
    }
     ...
     */
    public final void schedule(Runnable command, long delayInMillions) {
        if (!continueWorking) {
            throw new RejectedExecutionException();
        }
